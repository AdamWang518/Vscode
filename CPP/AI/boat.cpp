...
int handle(zt t)
{
	...
	if(	t.left_m == start_c && t.left_c == start_y)
	{
        ...
        for(i = 0; i <= Index ; i++)
		{
            ...
            if(ztarr[i].boat1_location==1)
            {
                printf("右\t");
            }
            else if(ztarr[i].boat1_location==-1)
            {
                printf("左\t");
            }
        ...
        if(ztarr[Index].cost<maxcost)
        {
            ...
            for(i = 0; i <= count ; i++)
            {
                ...
                costList[i].boat1_location=ztarr[i].boat1_location;
		...
		if(Index<maxstep)
		{
			...
			for(i = 0; i <= maxstep ; i++)
            {
                ...
                stepList[i].boat1_location=ztarr[i].boat1_location;
...
int main()
{
    ...
    for (int j = 0; j <= count ; j++)
    {
        ...
        if(costList[j].boat1_location==1)
        {
            printf("右\t");
        }
        else if(costList[j].boat1_location==-1)
        {
            printf("左\t");
        }
	...
	for (int j = 0; j <= maxstep ; j++)
    {
        ...
        if(stepList[j].boat1_location==1)
        {
            printf("右\t");
        }
        else if(stepList[j].boat1_location==-1)
        {
            printf("左\t");
        }
