...
def change_and_save():
    ...
    trainImageFile = 'D:\\Vscode\\Python\\AI\\Practice\\MNIST\\MNIST\\raw\\train-images-idx3-ubyte'
    _, _, _, images = mnist.load_image(trainImageFile)
    trainLabelFile = 'D:\\Vscode\\Python\\AI\\Practice\\MNIST\\MNIST\\raw\\train-labels-idx1-ubyte'
